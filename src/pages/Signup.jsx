    ...
    <div className="content">
      <Header login/>
        ...
        <div className="form">
             ...
             {showPassword && <input type="password" placeholder="Password"  onChange={(e)=>setFormValues({...formValues,[e.target.name]:e.target.value,})} name="password" value={formValues.password} />}
